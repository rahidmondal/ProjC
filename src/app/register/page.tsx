...
export default function RegisterPage() {
    ...
    return (
        <div className="flex h-screen">
            {/* Left Section (Form) */}
            <div className="w-1/2 flex flex-col justify-center items-center bg-white dark:bg-gray-900 p-8">
                ...
                <h2 className="text-3xl font-semibold text-gray-800 dark:text-white mb-4">Create Account</h2>
            ...
            <div className="w-1/2 relative flex items-center justify-center bg-white dark:bg-gray-900 p-8">
                <div className="absolute inset-0 clip-custom"></div>
                <Image src="/assets/register_banner.png" alt="Register Banner" width={617} height={600} className="relative z-10" />
            </div>
