...
import { Globe, Github, Linkedin, Instagram, Facebook, X, Upload, FolderOpen, NotebookPen } from "lucide-react";
...
const ProfilePage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    website: "https://myprashant.tech", // Ensure all fields have default values
    ...
    profilePicture: null, // For file input (avoid undefined)
  });
  ...
  return (
    <>
      <div
        className={`${
          isModalOpen ? "opacity-50 blue-sm pointer-events-none" : ""
        }`}
      >
        <Navbar />
      </div>
      <div className="my-14 flex justify-center items-center dark:text-white ">
        <div className="w-full max-w-6xl bg-[#dfdfdf] dark:bg-gray-800 rounded-lg p-6 flex flex-col md:flex-row gap-6 border border-gray-400 dark:border-gray-600 shadow-[6px_6px_8px_rgba(0,0,0,0.4)] dark:shadow-[6px_6px_8px_rgba(255,255,255,0.2)] ">
          ...
          <div className="w-full md:w-1/3 bg-white dark:bg-gray-700 shadow-md p-6 rounded-lg border border-gray-400 dark:border-gray-400">
            <div className="flex flex-col items-center">
              ...
              />
              <h2 className="text-xl font-semibold mt-4">Prashant Kumar</h2>
              <p className="text-gray-600 dark:text-gray-300">
                Full Stack Developer
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Burari, New Delhi - 110038
              </p>
            </div>
            ...
            <div className="mt-6 space-y-3">
              <ProfileLink
                Icon={Globe}
                label="Website"
                link="https://myprashant.tech"
              />
              <ProfileLink
                Icon={Github}
                label="Github"
                link="https://github.com/pkprashantkr"
              />
              <ProfileLink
                Icon={Linkedin}
                label="LinkedIn"
                link="prashant-kumar-ln"
              />
              <ProfileLink
                Icon={Instagram}
                label="Instagram"
                link="phobioc_prashant"
              />
              <ProfileLink
                Icon={Facebook}
                label="Facebook"
